...
{context}
    ...
    compare_system_template = """You are a Reg Reporting Assistant who has to answer question of a user from the institute {institute}.
        ...
        Just give the concluded response betwwen the relevant points from document 1 and document 2. If you have asked a question like based on the Payment service that {insutitute} follow that is not mentioned in annual report than go through the following:
